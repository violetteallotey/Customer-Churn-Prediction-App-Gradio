...
def input_df_creator(gender, DeviceProtection, MonthlyCharges, PaymentMethod, PaperlessBilling, Contract, StreamingMovies, StreamingTV, TechSupport, OnlineBackup, SeniorCitizen, OnlineSecurity, InternetService, MultipleLines, PhoneService, tenure, Dependents, Partner, TotalCharges):
...
#     try:
#         input_data["MonthlyCharges"] = float(MonthlyCharges)
#     except (ValueError, TypeError):
#         input_data["MonthlyCharges"] = 0.0

#     try:
#         input_data["TotalCharges"] = float(TotalCharges)
#     except (ValueError, TypeError):
...
def predict_churn(gender, DeviceProtection, MonthlyCharges, PaymentMethod, PaperlessBilling, Contract, StreamingMovies, StreamingTV, TechSupport, OnlineBackup, SeniorCitizen, OnlineSecurity, InternetService, MultipleLines, PhoneService, tenure, Dependents, Partner, TotalCharges):
    input_df = input_df_creator(gender, DeviceProtection, MonthlyCharges, PaymentMethod, PaperlessBilling, Contract, StreamingMovies, StreamingTV, TechSupport, OnlineBackup, SeniorCitizen, OnlineSecurity, InternetService, MultipleLines, PhoneService, tenure, Dependents, Partner, TotalCharges)
